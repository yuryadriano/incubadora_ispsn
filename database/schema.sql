...
CREATE TABLE IF NOT EXISTS `usuarios` (
  ...
  `tipo_utilizador` enum('estudante','docente','outro','pre_licenciado','mentor','funcionario') COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'estudante',
...
CREATE TABLE IF NOT EXISTS `candidaturas` (
  ...
  `pitch_path` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `tipo_candidato` enum('estudante','pre_licenciado') COLLATE utf8mb4_unicode_ci DEFAULT 'estudante',
